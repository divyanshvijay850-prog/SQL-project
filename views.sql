-- view 
-- SQL View ek virtual table hota hai jo ek SELECT query se banta hai.
-- Ye actual data store nahi karta, balki jab bhi view ko access kiya jata hai, original table se data dikhata hai.

-- A View is a database object that represents a virtual table created using a SQL SELECT query,
-- used to simplify complex queries and enhance data security.
