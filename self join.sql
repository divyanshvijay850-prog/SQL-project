...
show tables; 
-- self join
-- when we have one table and join it self
...
-- in reference of mager
select emp.emp_id,emp.emp_name,emp.salary,manager.emp_id,manager.emp_name,manager.salary from employee as manager
join
employee as emp
